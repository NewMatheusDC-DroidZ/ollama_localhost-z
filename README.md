A lightweight, responsive, and local-first web interface designed to interact with Ollama APIs. This project provides a clean aesthetic that works across Desktop and Mobile Termux environments.
Key Features
 * Dynamic Model Discovery: Automatically fetches and lists all locally installed models upon connection.
 * File Context Management: Attach text-based files to your prompts. Files are visualized as removable chips and interactive bubbles within the chat.
 ...
 * Enter your Base URL (default is http://127.0.0.1:11434) and select your model.
Termux (Android):
 * Install Python if not already present:
<!-- end list -->
pkg install python

 * Navigate to the directory containing index.html and start a local server:
<!-- end list -->
python -m http.server 8080

 * Access the UI via your mobile browser at:
<!-- end list -->
http://localhost:8080
 ...
 * Files appear as chips above the input bar.
 * Click the "x" on a chip to remove the file before sending.
